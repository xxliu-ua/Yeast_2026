function [eacc,eauc, acc, auc, para] = opt_svm(train_set,train_labels)
    ...
    for j = 1:n
        ...
        for p = 1:length(W)
            ...
            for kk = 1 : v
                ...
                [test_result, ensemble_test_result] = svm_classifier(train_subset,val_set,train_subset_labels,val_labels,para,testaug);
